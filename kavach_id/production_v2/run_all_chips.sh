...
echo CHIP_${CHIPNUM}_RESULT Ra0=${RA0} Rb0=${RB0} true_bit=\$&true_bit matches=\$&match_count mismatches=\$&mismatch_count
.endc
...
EOF
  ...
  ngspice -b chip${CHIPNUM}.sp 2>&1 | grep "CHIP_${CHIPNUM}_RESULT"
done
