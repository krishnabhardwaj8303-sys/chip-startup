module provenance_chain_lite_tb;
    ...
    initial begin
        $dumpfile("provenance_lite.vcd");
        $dumpvars(0, provenance_chain_lite_tb);

        rst = 1; record_stage = 0; stage_id = 0; stage_data = 0;
        #20; rst = 0; #10;

        $display("================================");
        $display("  KAVACH-ID LITE SUPPLY-CHAIN   ");
        $display("  Lightweight mix_hash, no SHA  ");
        $display("================================");
        ...
        $display("Final: hash=0x%08h, stages=%0b, complete=%0d",
        ...
        $display("================================");
        $display("Supply-Chain Provenance (LITE mix_hash) Complete!");
        $display("================================");
        $finish;
    end
endmodule
